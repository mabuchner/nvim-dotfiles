...
vim.keymap.set("n", "<leader>fg", ":Telescope live_grep_args<cr>", { noremap = true })
vim.keymap.set("v", "<leader>fg", '"zy<esc>:Telescope live_grep_raw default_text=<c-r>z<cr>', { noremap = true, silent = true })
